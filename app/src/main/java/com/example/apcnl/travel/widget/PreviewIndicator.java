package com.example.apcnl.travel.widget;
...
public class PreviewIndicator extends LinearLayout {
    ...
    //指示器个数
    public static int INDICATOR_COUNT = 3;
    ...
    public void initSize(int chosedSize,int nomal,int hei) {
        chooseSize = DensityUtil.dp2px(chosedSize);
        nomalSize = DensityUtil.dp2px(nomal);
        height = DensityUtil.dp2px(hei);
    }
